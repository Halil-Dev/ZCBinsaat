...
export default function VizyonMisyonPage() {
  ...
  const content = {
    TR: {
      ...
      visionText: "Güvenli zemin analizleri ve ileri teknoloji mühendisliği estetik mimariyle harmanlayarak, Kocaeli'de ve Türkiye genelinde geleceğin sarsılmaz, lüks ve sürdürülebilir yaşam alanlarını inşa eden öncü marka olmak.",
    ...
    EN: {
      ...
      visionText: "To be the leading brand constructing the unshakable, luxury, and sustainable living spaces of the future in Kocaeli and across Turkey, by blending safe ground analysis and advanced technology engineering with aesthetic architecture.",
    ...
    RU: {
      ...
      visionText: "Быть ведущим брендом, создающим незыблемые, роскошные и устойчивые жилые пространства будущего в Коджаэли и по всей Турции, сочетая надежный анализ грунта и передовые инженерные технологии с эстетичной архитектурой.",
